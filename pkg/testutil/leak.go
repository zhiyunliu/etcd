...
running(leaking) after all tests.
	...
	import "github.com/zhiyunliu/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/zhiyunliu/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/zhiyunliu/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
